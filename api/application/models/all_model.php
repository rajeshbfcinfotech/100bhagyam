...
function get_category($category_name = false, $category_id = false) {
		$this->db->select("c.category_id, c.category_name,c.description,c.image, c.status");
	...
	function save_add_category($category_id = false, $category_name,$description) {
	...
	function get_sub_category($sub_category_name = false, $category_id = false, $sub_category_id = false) {
		$this->db->select("c.sub_category_id, c.category_id, c.sub_category_name, c.description, c.image, c.status, cat.category_name");
	...
	function save_add_sub_category($sub_category_id = false, $category_id, $sub_category_name,$description) {
