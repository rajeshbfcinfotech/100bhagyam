...
Route::post('/apiRegister', 'User\ApiController@register');
Route::post('/apiEmailLogin', 'User\ApiController@login');
Route::post('/apiForget', 'User\ApiController@forget');
Route::get('/apiAllProdDtl', 'User\ApiController@AllProdDtl');
Route::post('/apiProdDtlByCat', 'User\ApiController@ProdDtlByCat');
Route::get('/apiAllCatDtl', 'User\ApiController@AllCatDtl');
Route::post('/apiPageData', 'User\ApiController@PageData');
Route::get('/apiSliderData', 'User\ApiController@SliderData');
Route::post('/apiListSubCatByCat', 'User\ApiController@ListSubCatByCat');

/*Route::get('/email', function () {
        $to_name = "rajesh";
        $to_email = "rajesh.bfcinfotech@gmail.com";
  ...
  // User Reset
  //Route::get('/api/reset', 'User\ApiUserController@resetform')->name('user-reset');
  //Route::post('/api/reset', 'User\ApiUserController@reset')->name('user-reset-submit');
  // User Reset End

 

  // User Forgot
 // Route::get('/api/forgot', 'User\ApiForgotController@showforgotform')->name('user-forgot');
 // Route::post('/api/forgot', 'User\ApiForgotController@forgot')->name('user-forgot-submit');
  // User Forgot Ends
